...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-dark-blue text-white" ref={sectionRef}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            <p className="font-inter text-white/80 text-center mb-12 max-w-2xl mx-auto">
              Ready to create something amazing? Let's discuss your next project.
            </p>
              ...
              <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
                ...
                <div className="space-y-4 mb-8">
                  <div>
                    ...
                    <a href="mailto:krishna98das@gmail.com" className="font-inter text-lg hover:text-white/80 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="tel:+353894144098" className="font-inter text-lg hover:text-white/80 transition-colors">
                      +353 894144098
                    </a>
                  </div>
